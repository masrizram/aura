...
2. Set the finding's status to `IN_PROGRESS` before starting work.
...
## Handoff
Return the list of changed files and the findings you addressed. Set finding status to `FIXED`. Do NOT mark a finding `VERIFIED` yourself — that is the verifier's job.
